-- ********************************************************************
-- * Filename        : hwm_tab.sql
-- * author:         : Jess Brock
-- * Original	       : 08-Jun-2016
-- * Last Update     : 08-Jun-2016
-- * Description     : Determine highwater mark for a given table
-- * Usage           : @hwm_tab.sql <owner> <table>
-- * Note            : May want to gather stats before running
-- ********************************************************************
def owner=UPPER(&1)
def tab=(UPPER&2)
def prog    = 'hwm.sql'
def title   = 'High water mark for table &tab'
@title
