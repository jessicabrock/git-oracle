----------------------------------------------------------------------------------------
--
-- File name:   mysnap.sql
--
-- Purpose:     Reports delta of sessions stats before and after a SQL query
--
-- Usage:       No parameters. It just needs to be executed twice. First execution just before the SQL that needs to be evaluated.
